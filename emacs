...
;; Russian
;;C-x SPC rectangle selective mode
(global-set-key (kbd "C-ы") 'bies-search)
(global-set-key (kbd "C-ф") 'mark-whole-buffer)
(global-set-key (kbd "C-й") 'kill-whole-line)
(global-set-key (kbd "C-в") 'bies-duplicate-line)
(global-set-key (kbd "C-ч d") 'delete-window)
(global-set-key (kbd "C-ч <up>") 'delete-other-windows)
(global-set-key (kbd "C-ч h") 'split-window-below)
(global-set-key (kbd "C-ч v") 'split-window-right)
(global-set-key (kbd "C-ч <right>") 'other-window)
(global-set-key (kbd "M-р") 'suspend-frame)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(glsl-mode yaml-mode charp-mode csharp-mode gnu-elpa-keyring-update lsp-mode lua-mode emacs-async helm doom-themes helpful counsel ivy-rich rainbow-delimiters doom-modeline multiple-cursors ivy use-package))
